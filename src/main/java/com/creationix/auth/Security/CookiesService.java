...
public class CookiesService {
    ...
    private final Logger logger = LoggerFactory.getLogger(CookiesService.class);
    ...
    /*CREATE METHOD TO ATTACH THE COOKIES RESPONSE*/
    public void attachRefreshCookie(HttpServletResponse response, String value, int maxAge) {
        logger.info("Attaching refresh token cookie: {} with max age: {} seconds", refreshTokenCookieName, maxAge);
    ...
    /*CLEAR THE REFRESH COOKIES IF USER LOGOUT*/
